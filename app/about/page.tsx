    ...
    <Container className="py-14">
      <section className="max-w-3xl">
        ...
        <p className="mt-5 text-lg leading-8 text-vault-secondaryText">
          We support Pokemon, One Piece, Riftbound, Magic: The Gathering, Japanese cards, English singles, sealed
          product, slabs, and collector bundles as inventory is available. Our goal is to make every listing clear, every
          product photo useful, and every transaction feel safe for collectors.
        </p>
      </section>
