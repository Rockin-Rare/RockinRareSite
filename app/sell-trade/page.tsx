...
export const metadata: Metadata = {
  ...
  description: "Submit singles, slabs, sealed product, bulk, or collections to Rockin Rare Collectibles for review."
};
    ...
    <Container className="grid gap-10 py-14 lg:grid-cols-[0.8fr_1.2fr]">
      <div>
        ...
        <p className="mt-5 text-lg leading-8 text-vault-secondaryText">
          Have singles, slabs, sealed product, or bulk? Send us photos and details and we&apos;ll review your collection.
        </p>
